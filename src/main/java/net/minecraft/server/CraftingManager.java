...
public class CraftingManager {
    ...
    public CraftingManager() { // CraftBukkit - private -> public
      ...
      //Nouveaux crafts
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_BLANC, 6), new Object[] {"#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 0)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_NOIR, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 15)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_GRIS_FONCE, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 7)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_ROUGE, 6), new Object[] {"#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 14)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_ROSE, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 6)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_VERT, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 13)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_VERT_CLAIR, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 5)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_MARRON, 6), new Object[] {"#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 12)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_JAUNE, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 4)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_BLEU, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 11)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_BLEU_CLAIR, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 3)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_VIOLET, 6), new Object[] {"#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 10)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_MAGENTA, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 2)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_CYAN, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 9)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_ORANGE, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 1)});
        this.registerShapedRecipe(new ItemStack(Block.TAPIS_GRIS_CLAIR, 6), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 8)});
       
        this.registerShapedRecipe(new ItemStack(Block.RED_STAIRS, 4), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 14)});
        this.registerShapedRecipe(new ItemStack(Block.ROSE_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 6)});
        this.registerShapedRecipe(new ItemStack(Block.BLACK_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 15)});
        this.registerShapedRecipe(new ItemStack(Block.DARKGREY_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 7)});
        this.registerShapedRecipe(new ItemStack(Block.DARKGREEN_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 13)});
        this.registerShapedRecipe(new ItemStack(Block.GREEN_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 5)});
        this.registerShapedRecipe(new ItemStack(Block.BROWN_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 12)});
        this.registerShapedRecipe(new ItemStack(Block.YELLOW_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 4)});
        this.registerShapedRecipe(new ItemStack(Block.DARKBLUE_STAIRS, 6), new Object[] {"#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 11)});
        this.registerShapedRecipe(new ItemStack(Block.BLUE_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 3)});
        this.registerShapedRecipe(new ItemStack(Block.DARKVIOLET_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 10)});
        this.registerShapedRecipe(new ItemStack(Block.VIOLET_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 2)});
        this.registerShapedRecipe(new ItemStack(Block.CYAN_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 9)});
        this.registerShapedRecipe(new ItemStack(Block.ORANGE_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 1)});
        this.registerShapedRecipe(new ItemStack(Block.GREY_STAIRS, 6), new Object[] { "#  ", "## ", "###", Character.valueOf('#'), new ItemStack(Block.WOOL, 35, 8)});
