...
public class Block {
  ...
  //Nouveaux blocs
    public static final Block RED_STAIRS = (new BlockWoolStairs(125, 129, WOOL)).a("stairsWool").j();
    public static final Block ROSE_STAIRS = (new BlockWoolStairs(126, 130, WOOL)).a("stairsWool").j();
    public static final Block BLACK_STAIRS = (new BlockWoolStairs(127, 113, WOOL)).a("stairsWool").j();
    public static final Block DARKGREY_STAIRS = (new BlockWoolStairs(128, 114, WOOL)).a("stairsWool").j();
    public static final Block DARKGREEN_STAIRS = (new BlockWoolStairs(129, 145, WOOL)).a("stairsWool").j();
    public static final Block GREEN_STAIRS = (new BlockWoolStairs(130, 146, WOOL)).a("stairsWool").j();
    public static final Block BROWN_STAIRS = (new BlockWoolStairs(131, 161, WOOL)).a("stairsWool").j();
    public static final Block YELLOW_STAIRS = (new BlockWoolStairs(132, 162, WOOL)).a("stairsWool").j();
    public static final Block DARKBLUE_STAIRS = (new BlockWoolStairs(133, 177, WOOL)).a("stairsWool").j();
    public static final Block BLUE_STAIRS = (new BlockWoolStairs(134, 178, WOOL)).a("stairsWool").j();
    public static final Block DARKVIOLET_STAIRS = (new BlockWoolStairs(135, 193, WOOL)).a("stairsWool").j();
    public static final Block VIOLET_STAIRS = (new BlockWoolStairs(136, 194, WOOL)).a("stairsWool").j();
    public static final Block CYAN_STAIRS = (new BlockWoolStairs(137, 209, WOOL)).a("stairsWool").j();
    public static final Block ORANGE_STAIRS = (new BlockWoolStairs(138, 210, WOOL)).a("stairsWool").j();
    public static final Block GREY_STAIRS = (new BlockWoolStairs(139, 225, WOOL)).a("stairsWool").j();


    public static final Block TAPIS_BLANC = (new BlockTapis(140, 64)).c(0.5F).a(k).a("TapisBlanc").f(0);
    public static final Block TAPIS_NOIR = (new BlockTapis(141, 64)).c(0.5F).a(k).a("TapisNoir").f(0);
    public static final Block TAPIS_GRIS_FONCE = (new BlockTapis(142, 64)).c(0.5F).a(k).a("TapisGrisFonce").f(0);
    public static final Block TAPIS_ROUGE = (new BlockTapis(143, 64)).c(0.5F).a(k).a("TapisRouge").f(0);
    public static final Block TAPIS_ROSE = (new BlockTapis(144, 64)).c(0.5F).a(k).a("TapisRose").f(0);
    public static final Block TAPIS_VERT = (new BlockTapis(145, 64)).c(0.5F).a(k).a("TapisVert").f(0);
    public static final Block TAPIS_VERT_CLAIR = (new BlockTapis(146, 64)).c(0.5F).a(k).a("TapisvertClair").f(0);
    public static final Block TAPIS_MARRON = (new BlockTapis(147, 64)).c(0.5F).a(k).a("TapisMarron").f(0);
    public static final Block TAPIS_JAUNE = (new BlockTapis(148, 64)).c(0.5F).a(k).a("TapisJaune").f(0);
    public static final Block TAPIS_BLEU = (new BlockTapis(149, 64)).c(0.5F).a(k).a("TapisBleu").f(0);
    public static final Block TAPIS_BLEU_CLAIR = (new BlockTapis(150, 64)).c(0.5F).a(k).a("TapisBleuClair").f(0);
    public static final Block TAPIS_VIOLET = (new BlockTapis(151, 64)).c(0.5F).a(k).a("TapisViolet").f(0);
    public static final Block TAPIS_MAGENTA = (new BlockTapis(152, 64)).c(0.5F).a(k).a("TapisMagenta").f(0);
    public static final Block TAPIS_CYAN = (new BlockTapis(153, 64)).c(0.5F).a(k).a("TapisCyan").f(0);
    public static final Block TAPIS_ORANGE = (new BlockTapis(154, 64)).c(0.5F).a(k).a("TapisOrange").f(0);
    public static final Block TAPIS_GRIS_CLAIR = (new BlockTapis(155, 64)).c(0.5F).a(k).a("TapisGrisClair").f(0);
	...
	public void a_(World world, int i2, int j2, int k2) {
