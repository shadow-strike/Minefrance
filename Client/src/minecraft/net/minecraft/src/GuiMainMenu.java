...
public class GuiMainMenu extends GuiScreen
{
    ...
    private GuiButton minefranceButton;
    ...
    public void initGui()
    {
        ...
        controlList.add(minefranceButton = new GuiButton(6, width / 2 - 0, i + 12 + 12, 98, 20, stringtranslate.translateKey("Minefrance")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            mc.displayGuiScreen(new GuiConnecting(mc, "minefrance.com", 25565));
        }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        drawString(fontRenderer, "Minefrance 2.3", 2, height - 10, 0xffffff);
        String s = "Copyright Ninjatoent";
