...
class ContainerCreative extends Container
{
    ...
    public ContainerCreative(EntityPlayer par1EntityPlayer)
    {
        ...
        Block ablock[] =
        {
            ...
            Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.obsidian, Block.netherrack, Block.slowSand, Block.glowStone,
            ...
            Block.RedWoolStairs, Block.RoseWoolStairs, Block.BlackWoolStairs, Block.DarkGreyWoolStairs, Block.DarkGreenWoolStairs, Block.GreenWoolStairs, Block.BrownWoolStairs, Block.YellowWoolStairs, Block.DarkBlueWoolStairs, Block.BlueWoolStairs, Block.DarkVioletWoolStairs, Block.VioletWoolStairs, Block.CyanWoolStairs, Block.OrangeWoolStairs, Block.GreyWoolStairs, 
            Block.dispenser, Block.stoneOvenIdle,
