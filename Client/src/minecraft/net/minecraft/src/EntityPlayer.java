...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        playerCloakUrl = (new StringBuilder()).append("http://minefrance.com/MinecraftCloaks/").append(username).append(".png").toString();
        cloakUrl = playerCloakUrl;
    }
    public void updateHat()
    {
        playerHatUrl = (new StringBuilder()).append("http://minefrance.com/MinecraftHats/").append(username).append(".png").toString();
        hatUrl = playerHatUrl;
    }
