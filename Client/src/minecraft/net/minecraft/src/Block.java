...
public class Block
{
  ...
  //Nouveaux blocs
    ...
    public static final Block RoseWoolStairs;
    public static final Block BlackWoolStairs;
    public static final Block DarkGreyWoolStairs;
    public static final Block DarkGreenWoolStairs;
    public static final Block GreenWoolStairs;
    public static final Block YellowWoolStairs;
    public static final Block DarkBlueWoolStairs;
    public static final Block BlueWoolStairs;
    public static final Block DarkVioletWoolStairs;
    public static final Block VioletWoolStairs;
    public static final Block CyanWoolStairs;
    public static final Block OrangeWoolStairs;
    public static final Block GreyWoolStairs;
    public static final Block BrownWoolStairs;
    //Fin
    ...
    static
    {
      ...
      //Nouveaux blocs
        TapisBlanc = (new BlockTapis(140, 64)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisBlanc").setLightOpacity(0);
        TapisNoir = (new BlockTapis(141, 113)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisNoir").setLightOpacity(0);
        TapisGrisFonce = (new BlockTapis(142, 114)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisGrisFonce").setLightOpacity(0);
        TapisRouge = (new BlockTapis(143, 129)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisRouge").setLightOpacity(0);
        TapisRose = (new BlockTapis(144, 130)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisRose").setLightOpacity(0);
        TapisVert = (new BlockTapis(145, 145)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisVert").setLightOpacity(0);
        TapisVertClair = (new BlockTapis(146, 146)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisVertClair").setLightOpacity(0);
        TapisMarron = (new BlockTapis(147, 161)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisMarron").setLightOpacity(0);
        TapisJaune = (new BlockTapis(148, 162)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisJaune").setLightOpacity(0);
        TapisBleu = (new BlockTapis(149, 177)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisBleu").setLightOpacity(0);
        TapisBleuClair = (new BlockTapis(150, 178)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisBleuClair").setLightOpacity(0);
        TapisViolet = (new BlockTapis(151, 193)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisViolet").setLightOpacity(0);
        TapisMagenta = (new BlockTapis(152, 194)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisMagenta").setLightOpacity(0);
        TapisCyan = (new BlockTapis(153, 209)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisCyan").setLightOpacity(0);
        TapisOrange = (new BlockTapis(154, 210)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisOrange").setLightOpacity(0);
        TapisGrisClair = (new BlockTapis(155, 225)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("TapisGrisClair").setLightOpacity(0);
        RedWoolStairs = (new BlockStairsWool(125, 129, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        RoseWoolStairs = (new BlockStairsWool(126, 130, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        BlackWoolStairs = (new BlockStairsWool(127, 113, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        DarkGreyWoolStairs = (new BlockStairsWool(128, 114, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        DarkGreenWoolStairs = (new BlockStairsWool(129, 145, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        GreenWoolStairs = (new BlockStairsWool(130, 146, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        BrownWoolStairs = (new BlockStairsWool(131, 161, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        YellowWoolStairs = (new BlockStairsWool(132, 162, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        DarkBlueWoolStairs = (new BlockStairsWool(133, 177, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        BlueWoolStairs = (new BlockStairsWool(134, 178, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        DarkVioletWoolStairs = (new BlockStairsWool(135, 193, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        VioletWoolStairs = (new BlockStairsWool(136, 194, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        CyanWoolStairs = (new BlockStairsWool(137, 209, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        OrangeWoolStairs = (new BlockStairsWool(138, 210, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        GreyWoolStairs = (new BlockStairsWool(139, 225, cloth)).setBlockName("stairsWool").setRequiresSelfNotify();
        //Fin 
